...
<head>
  ...
  <meta property="og:description" content="Technologist" />
  <meta property="og:url" content="https://mackenzie1.github.io/" />
  ...
  <meta name="author" content="Mackenzie Harwood" />
  <meta name="description" content="Technologist with a passion for automation, security, and cloud native solutions." />
...
<body>
  ...
  <nav class="hide-on-large only trigger z-depth-1">
    ...
    <div class="name-title">
      <a id="name" aria-label="Navigate to the beginning of the page" href="#" class="teal-text">Mackenzie 
        Harwood</a><span class="black-text">Technologist</span>
    </div>
  </nav>
  ...
  <nav class="hide-on-large only">
    <ul id="slide-out" class="side-nav">
      ...
      <li class="bold">
        <a aria-label="Open Mackenzie's Resume in a new tab"
          href="https://docs.google.com/document/d/e/2PACX-1vSwr8kEj_eQxM-hTSLf4oczuKcVFoSMSGzpFMzfdx9_v_MRvi3YI-YLK7PxNG51hw/pub" target="_blank"
          class="waves-effect waves-dark teal-text"><i class="mdi-file-folder-open small"></i><span>Resume</span></a>
      </li>
    </ul>
  </nav>
  ...
  <main>
      ...
      <div class="container">
        <div class="col-md-9">
          <div class="content section-padding valign" style="margin-left: 10%; margin-top: 50px;">
            ...
            <div class="social">
              <a href="https://www.linkedin.com/in/mackenzie-harwood-a896ab199/" target="_blank">
                <button class="icon-btn linkedin">
                  <i class="fa fa-linkedin"></i>
                </button>
              </a>
              <a href="https://github.com/mackenzie1" target="_blank">
    ...
    <section id="about" class="section scrollspy">
      ...
      <div class="container flow-text">
        ...
        <p>
          ...
          I have worked on technologies like Java, Selenium, Kubernetes, MySQL, PostgreSQL, MongoDB, HTML5, CSS, Python, Jenkins. 

          I am passionate about developing complex applications that solve real-world problems impacting millions of users.
        </p>
        <p>
          <ul>
            <li><b>Languages:</b> Java, Python, JavaScript, C, C++, HTML/CSS, Bash</li>
            <li><b>Databases:</b> MySQL, PostgreSQL, MongoDB</li>
            <li><b>Libraries:</b> NumPy, Pandas, Selenium</li>
            <li><b>Frameworks:</b>  Node.js, PyTorch, Bootstrap, Angular</li>
            <li><b>Tools & Technologies:</b> Git, Docker, AWS, GCP,  JIRA</li>
          </ul>
      ...
      <div class="container">
          ...
          <div class="card-content">
            <div class="row">
              <div class="col s12 m2">
                <a href="https://www.cvpcorp.com/" target="_blank"><img alt="CVP logo"
                    src="/assets/img/cvp.jpg" class="responsive-img center-block" /></a>
              </div>
              <!-- <div class="col s12 m10"> -->
              <div class="col s12 m10">
                <p>
                  <span class="card-title"><a href="https://www.cvpcorp.com/" target="_blank"
                      class="teal-text hoverline">CVP</a></span>
                </p>
              </div>
            </div>
            <div class="role brown-text text-darken-2">Associate Technologist</div>
            <ul>
              <li>
                Completed and maintained automated tests for mulpiple sites and projects.
              </li>
              <li>
                Worked as part of a team to complete code challenges as part of the contract aquisition process.
              </li>
              <li>Lead and participated in cloud computing learning sessions.</li>
              <li>
                <b>Tools:</b> Java, Selenium, Jenkins
              </li>
            </ul>
          </div>
          <div class="card-action">
            <span>June 2021 - Present | Baltimore, Maryland</span>
          </div>
        </div>
              ...
              <div class="col s12 m10">
                <p>
                  <span class="card-title"><a href="https://datasciencecorps.umbc.edu/" target="_blank"
                      class="teal-text hoverline">UMBC IS Department</a></span>
                </p>
              </div>
            </div>
            <div class="role brown-text text-darken-2">Data Science Undergrad Research Intern</div>
            <ul>
              <li>
                Use data to generate information used to improve the quality of in Baltimore.
              </li>
              <li>
                Used computer aided design tools to visualize data and draw insights.
              </li>
              <li>
                Helped document and prepare our findings for the next team to use.
              </li>

              <li>
                <b>Tools:</b> Python, ESRI, CAD
              </li>
            </ul>
          </div>
          <div class="card-action">
            <span>August 2019 - May 2021 | Baltimore, Maryland</span>
          </div>
        </div>
        ...
        <div class="card">
          <div class="card-content">
            <div class="row">
              <div class="col s12 m2">
                <a href="https://www.websiteinnovator.com/" target="_blank"><img alt="UMBC logo"
            ...
            <div class="role brown-text text-darken-2">Front End Developer Intern</div>
            <ul>
              <li>
                Use design and code to build the frontend of ecommerce sites for small businesses.
              </li>
              <li>
                Utilize various WordPress plugins to provide functionaility and save resources.
              </li>
              <li>
                <b>Tools:</b> Html, CSS, JavaScript, WordPress
              </li>
            </ul>
          </div>
          <div class="card-action">
            <span>June 2020 - August 2020 | Gaithersburg, Maryland</span>
          </div>
        </div>
        ...
        <div class="card">
          <div class="card-content">
            <div class="row">
              <div class="col s12 m2">
                <a href="https://www.cignex.com" target="_blank"><img alt="Daly logo"
                    src="/assets/img/daly.jpg" class="responsive-img center-block" /></a>
              </div>
              <div class="col s12 m10">
                <p>
                  <span class="card-title"><a href="https://www.cignex.com" target="_blank"
                      class="teal-text hoverline">Daly Computers </a></span>
                </p>
              </div>
            </div>
            <div class="role brown-text text-darken-2">Production Technician</div>
            <ul>
              <li>
              ...
              <li>
                <b>Tools:</b> Bitlocker, Active Directory
              </li>
            </ul>
          </div>
          <div class="card-action">
            <span>May 2019 - August 2019 | Clarksburg, Maryland</span>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col s12 m6 l4">
            <div class="card medium">
              ...
              <div class="card-content">
                <span class="card-title activator teal-text hoverline">Stereo Punch!<i
                    class="mdi-navigation-more-vert right"></i></span>
                <p>
                  A music blog/magazine I built and maintain for a friend.
                </p>
              </div>
              <div class="card-reveal">
                ...
                <ul>
                  <li><b>Tools:</b> HTML, CSS, Bootstrap, Heroku</li>
                  <li>Static site used to display blog posts.</li>
                  <li>Search and filter blogs based on category and tags.</li>
                ...
                <div class="card-action">
                  ...
                  <a aria-label="Visit the GitHub repo for  project" href="https://github.com/mackenzie1/StereoPunch"
          ...
          <div class="col s12 m6 l4">
            <div class="card medium">
              ...
              <div class="card-content">
                <span class="card-title activator teal-text hoverline">Coming Soon!<i
                    class="mdi-navigation-more-vert right"></i></span>
                <p>
                  An automated messaging web app based
                </p>
              </div>
              <div class="card-reveal">
                {/* <!-- TODO: change this -- only close button --> */}
      ...
      <div class="container">
        ...
        <div class="card">
          <div class="card-content">
            ...
            <div class="row text-center">
              ...
              <div class="col s4 m2">
                <img alt="" src="/assets/img/selenium.jpg" class="responsive-img" />Selenium
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="card">
          <div class="card-content">
            ...
            <div class="row text-center">
              <div class="col s4 m2">
                <img alt="" src="/assets/img/nodejs.png" class="responsive-img" />Node.js
              </div>
              <div class="col s4 m2">
                <img alt="" src="/assets/img/bootstrap.png" class="responsive-img" />Bootstrap
              </div>
              <div class="col s4 m2">
                <img alt="" src="/assets/img/angular.jpg" class="responsive-img" />Angular
              </div>
              <div class="col s4 m2">
        ...
        <div class="card">
          <div class="card-content">
            ...
            <div class="row text-center">
              ...
              <div class="col s4 m2">
                <img alt="" src="/assets/img/git-logo.png" class="responsive-img" />     GIT     
              </div>
              <div class="col s4 m2">
        ...
        <div class="row">
          ...
          <div class="col s12 m6 l6">
            <div class="card">
              <div class="card-content">
                <p>
                  <span class="card-title"><a href="https://www.frostburg.edu/academics/colleges-and-departments/computer-science/" target="_blank" class="teal-text hoverline">Frostburg State University</a></span>
                </p>
                ...
                <ul>
                  ...
                  <ul>
                    <li>Foundations of Technology</li>
                    <li>Critical Thinking</li>
                    <li>Introdution to Programming</li>                    
                  </ul>
                  </p>
          ...
          <div class="col s12 m6 l6">
            <div class="card">
              <div class="card-content">
                <p>
                  <span class="card-title"><a href="https://informationsystems.umbc.edu/" target="_blank" class="teal-text hoverline">University of Maryland Balitmore County</a></span>
                </p>
    ...
    <section id="contact" class="section scrollspy full-height">
      ...
      <div class="container">
        <p>
          <a aria-label="Email Mackenzie" href="mailto:mackenzie.harwood1@gmail.com" target="_blank" data-position="top"
            data-tooltip="Email Mackenzie" class="btn-floating btn-large waves-effect waves-light blue-grey tooltipped"><i
              class="fa fa-envelope"></i><a aria-label="Email Mackenzie" href="mailto:mackenzie.harwood1@gmail.com"
              class="hoverline">mackenzie.harwood1@gmail.com</a></a>
        </p>
        <p>
          <a aria-label="View Mackenzie on GitHub" href="https://github.com/mackenzie1" target="_blank"
            data-position="top" data-tooltip="View Mackenzie on GitHub"
            class="btn-floating btn-large waves-effect waves-light blue-grey tooltipped"><i class="fa fa-github"></i><a
              aria-label="Mackenzie on Github" href="https://github.com/mackenzie1" class="hoverline"
              target="_blank">github.com/mackenzie1</a></a>
        </p>
        <p>
          <a aria-label="View Mackenzie on LinkedIn" href="https://www.linkedin.com/in/mackenzie-harwood-a896ab199/" target="_blank"
            data-position="top" data-tooltip="View Mackenzie on LinkedIn"
            class="btn-floating btn-large waves-effect waves-light blue-grey tooltipped"><i
              class="fa fa-linkedin"></i><a aria-label="Mackenzie on LinkedIn" href="https://www.linkedin.com/in/mackenzie-harwood-a896ab199/"
              class="hoverline" target="_blank">linkedin.com/in/mackenzieharwood</a></a>
        </p>
      </div>
    </section>
  </main>
  ...
  <script type="text/javascript">
    var typed = new Typed('.typing',{
      strings: ["Technologist", "Developer", "Test Automater","Cloud Native Enthusiast"],
      loop: true,
      typeSpeed: 80,
      backSpeed: 40
    });
